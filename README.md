...
ratings.csv y users.csv. Estas fuentes de datos pueden ser descargadas desde los siguientes enlaces: [Datos de L1](https://www.kaggle.com/datasets/mohamedbakhet/amazon-books-reviews/data?select=books_data.csv) y [Datos de L2](https://www.kaggle.com/datasets/saurabhbagchi/books-dataset/data). En estos mismos enlaces también es posible obtener información descriptiva de los datos.
